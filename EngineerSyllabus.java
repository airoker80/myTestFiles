 ...
 */
public class EngineerSyllabus extends AppCompatActivity implements ListView.OnItemClickListener {
    ListView listView1;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_Practice,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(EngineerSyllabus.this, response, Toast.LENGTH_LONG).show();
                            //op(response);
                        } else {
                            Toast.makeText(EngineerSyllabus.this, response, Toast.LENGTH_LONG).show();
                            op1(response);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EngineerSyllabus
    ...
    private void op1(String response) {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                String post ="Syllabus :" + jo.getString("Syllabus");
            ...
            ListAdapter adapter = new SimpleAdapter(
                    EngineerSyllabus.this, list1, R.layout.practice_item_list,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(id_no1== 1){
            startActivity(new Intent(EngineerSyllabus.this,Constitution.class));
        }
        if(id_no1==2){
            startActivity(new Intent(EngineerSyllabus.this,Administration.class));
        }
        if(id_no1==3){
            startActivity(new Intent(EngineerSyllabus.this,Poolicy.class));
        }
        if(id_no1==4){
            startActivity(new Intent(EngineerSyllabus.this,Development.class));
        }
        if(id_no1==5){
            startActivity(new Intent(EngineerSyllabus.this,Governance.class));
        }
    }
}
