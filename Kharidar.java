 ...
 */
public class Kharidar extends AppCompatActivity implements ListView.OnItemClickListener {
    ListView listView1;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_Practice,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(Kharidar.this, response, Toast.LENGTH_LONG).show();
                            //op(response);
                        } else {
                            Toast.makeText(Kharidar.this, response, Toast.LENGTH_LONG).show();
                            op1(response);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Kharidar.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        )
    ...
    private void op1(String response) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Kharidar.this, list1, R.layout.practice_item_list,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(id_no1== 1){
            startActivity(new Intent(Kharidar.this,Constitution.class));
        }
        if(id_no1==2){
            startActivity(new Intent(Kharidar.this,Administration.class));
        }
        if(id_no1==3){
            startActivity(new Intent(Kharidar.this,Poolicy.class));
        }
        if(id_no1==4){
            startActivity(new Intent(Kharidar.this,Development.class));
        }
        if(id_no1==5){
            startActivity(new Intent(Kharidar.this,Governance.class));
        }
    }
}
