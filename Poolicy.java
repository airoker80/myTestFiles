 ...
 */
public class Poolicy extends AppCompatActivity{
    ListView listView1;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(Poolicy.this, response, Toast.LENGTH_LONG).show();
                            //op(response);
                        } else {
                            Toast.makeText(Poolicy.this, response, Toast.LENGTH_LONG).show();
                            op1(response);
    ...
    private void op1(String response) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Poolicy.this, list1, R.layout.sachibqa,
