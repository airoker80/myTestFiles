 ...
 */
public class SahaSachib extends AppCompatActivity implements ListView.OnItemClickListener {
    ListView listView1;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")) {
                            Toast.makeText(SahaSachib.this, response, Toast.LENGTH_LONG).show();
                            //op(response);
                        } else {
                            Toast.makeText(SahaSachib.this, response, Toast.LENGTH_LONG).show();
                            op1(response);
    ...
    private void op1(String response) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    SahaSachib.this, list1, R.layout.practice_item_list,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(id_no1== 1){
            startActivity(new Intent(SahaSachib.this,Constitution.class));
        }
        if(id_no1==2){
            startActivity(new Intent(SahaSachib.this,Administration.class));
        }
        if(id_no1==3){
            startActivity(new Intent(SahaSachib.this,Poolicy.class));
        }
        if(id_no1==4){
            startActivity(new Intent(SahaSachib.this,Development.class));
        }
        if(id_no1==5){
            startActivity(new Intent(SahaSachib.this,Governance.class));
        }
    }
}
